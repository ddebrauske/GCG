#`created by D.Debrauske 20210309
#` 
#`@data.combined is the tidy format long data from using TimeseriesLayoutBlank()
#`
#`this function takes the long, tidy data.combined format, and generates a datafile to use with growthcurver functions
