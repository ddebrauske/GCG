#A function to parse through a plate matrix style table and return a "long" dataframe, with each "well" as a row

#this function is used inside of the PlateLayout() and PlateBlank() function. 
