#Plate reader type must be exactly 

#"magellan" or "spark" 

#Read.interval timepoint interval in minutes.

#plate reader data files must all be in a folder with no other .csv files. i reccommend making a new directory for these files. "Plate reader data"
